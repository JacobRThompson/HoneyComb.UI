namespace HoneyCombTests
{
    partial class DemoForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            HoneyComb.UI.StronglyTypedControls.StronglyTypedTag stronglyTypedTag4 = new HoneyComb.UI.StronglyTypedControls.StronglyTypedTag();
            ...
            button2 = new Button();
            button3 = new Button();
            stringTextBox1 = new Honeycomb.UI.StronglyTypedControls.TextBoxes.StringTextBox();
            stringTextBox2 = new Honeycomb.UI.StronglyTypedControls.TextBoxes.StringTextBox();
            stringTextBox3 = new Honeycomb.UI.StronglyTypedControls.TextBoxes.StringTextBox();
            stringTextBox4 = new Honeycomb.UI.StronglyTypedControls.TextBoxes.StringTextBox();
            stringTextBox5 = new Honeycomb.UI.StronglyTypedControls.TextBoxes.StringTextBox();
            stringTextBox6 = new Honeycomb.UI.StronglyTypedControls.TextBoxes.StringTextBox();
            label1 = new Label();
            label2 = new Label();
            ...
            Controls.Add(label2);
            Controls.Add(label1);
            Controls.Add(stringTextBox6);
            Controls.Add(stringTextBox5);
            Controls.Add(stringTextBox4);
            Controls.Add(stringTextBox3);
            Controls.Add(stringTextBox2);
            Controls.Add(stringTextBox1);
        ...
        private Honeycomb.UI.StronglyTypedControls.TextBoxes.StringTextBox stringTextBox1;
        private Honeycomb.UI.StronglyTypedControls.TextBoxes.StringTextBox stringTextBox2;
        private Honeycomb.UI.StronglyTypedControls.TextBoxes.StringTextBox stringTextBox3;
        private Honeycomb.UI.StronglyTypedControls.TextBoxes.StringTextBox stringTextBox4;
        private Honeycomb.UI.StronglyTypedControls.TextBoxes.StringTextBox stringTextBox5;
        private Honeycomb.UI.StronglyTypedControls.TextBoxes.StringTextBox stringTextBox6;
